           ...
           ' <div class="mod-ft">',
              '  <ul class="discuss-list">',
                   ' <li class="more-discuss">',
                    ...
                    // 显示2条最新评论，倒序显示
                    for (var ni = oImage.comment_count-1; ni > oImage.comment_count-3 && ni > 0; ni--){
                        dict = {'comment_username':oImage.comment_username[ni], 'comment_uid':oImage.comment_uid[ni],
                            'comment_content':oImage.comment_content[ni] };

                        sHtml_part2 += that.tpl([
                        '    <li>',
                            '    <a class="_4zhc5 _iqaka" title="#{comment_username}" href="/profile/#{comment_uid}" data-reactid=".0.1.0.0.0.2.1.2:$comment-17856951190001917.1">#{comment_username}</a>',
                            '    <span>',
